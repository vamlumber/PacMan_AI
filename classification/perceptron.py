        ...
        for iteration in range(self.max_iterations):
            ...
            for i in range(len(trainingData)):
                ...
                for label in self.legalLabels:
                    result = f * self.weights[label]
                    #Classify Function doesnot work right
                    if result > max_score:
                ...
                if best_label != actual_label:  # prediction is incorrect
                    self.weights[actual_label] = self.weights[actual_label] + f 
                    self.weights[best_label] = self.weights[best_label] - f 
